...
public class Q1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            //Query
            Table resultTable = lineitem.filter("L_SHIPDATE <= '1998-09-02'").groupBy("L_RETURNFLAG,L_LINESTATUS").select("L_RETURNFLAG,L_LINESTATUS,L_QUANTITY.sum as SUM_QTY,(L_EXTENDEDPRICE*(1-L_DISCOUNT)).sum as SUM_DISC_PRICE," +
